...
// This array is for placing an x or o in a square.
function placeXOrO(squareNumber) {
    //This condition ensures a square hadn't been selected already.
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        audio('./media/moving_the_piece.mp3');
...
// darwline() function is called to draw a line on the screen if the condition is met.
...
function audio(audioURL) {
    // We creater a new audio object and we pass the path as a parameter.
